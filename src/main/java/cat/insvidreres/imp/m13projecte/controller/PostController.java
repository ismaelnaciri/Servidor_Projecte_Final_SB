...
public class PostController {
    ...
    @PostMapping("/posts")
    public JSONResponse savePost(@RequestBody Map<String, Object> payload, @RequestHeader("idToken") String idToken, @RequestParam("category") String category) throws ExecutionException, InterruptedException, IOException {

        return postService.createPost(payload, idToken, category);
    }

    @PostMapping("/postsAndroid")
    public JSONResponse savePostAndorid(@RequestHeader("idToken") String idToken, @RequestBody Map<String, Object> postBody) throws ExecutionException, InterruptedException, IOException {
        return postService.createPostAndorid(idToken, postBody);
    }
